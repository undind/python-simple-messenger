...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plainTextEdit.setPlaceholderText(_translate("MainWindow", "Сообщения будут здесь"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Введите сообщение тут"))
